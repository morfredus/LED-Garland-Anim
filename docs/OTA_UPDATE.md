...
## Method 1: Web-Based OTA Update (v1.11.2+) ⭐
...
- **v1.11.2**: Added double-click confirmation for OTA updates
- **v1.11.2**: Added web-based OTA update interface
- **v1.11.2**: Added ArduinoOTA support
