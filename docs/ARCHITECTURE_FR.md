...
# 📚 Architecture - LED-Garland-Anim v1.10.0

## 🎯 Vue d'ensemble

LED-Garland-Anim v1.10.0 est désormais unifié pour la carte ESP32 IdeaSpark avec écran LCD ST7789 intégré (1.14").
...
- Ce document : v1.10.0 (2025-12-31)
