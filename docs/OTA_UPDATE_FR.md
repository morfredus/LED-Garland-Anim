...
## Méthode 1 : Mise à jour OTA via interface web (v1.11.0+) ⭐
...
- **v1.11.0** : Ajout de la confirmation par double-clic pour les mises à jour OTA
- **v1.11.0** : Ajout de l'interface de mise à jour OTA via web
- **v1.11.0** : Ajout du support ArduinoOTA
