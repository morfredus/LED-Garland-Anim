...
> 📌 **Guide débutant** : Ce document explique comment connecter physiquement les composants à votre carte ESP32 Classic pour le projet Anim-Guirlande.
...
#### Tableau récapitulatif LCD ST7789
