...
- **Flash-Free Experience**: No page reloads when changing animations/modes (v1.11.2)
...
- **Candle**: Flickering candle flame (redesigned in v1.11.2)
...
- **Stocking**: Hanging Christmas stocking (redesigned in v1.11.2)
...
- **Countdown**: 3-2-1 countdown display (redesigned in v1.11.2)
- **Confetti**: Falling colorful confetti
- **Clock**: Analog clock face with moving hands (fixed in v1.11.2)
...
- **Sparkle Rain**: Falling sparkles (fixed in v1.11.2)
- **Plasma**: Colorful plasma effect
- **Matrix Rain**: Digital Matrix-style falling characters (fixed in v1.11.2)
- **Spiral**: Rotating spiral pattern
- **Heart**: Pulsing heart shape
- **Stars Field**: Twinkling starfield
- **Campfire**: Realistic fire simulation (NEW in v1.11.2)
- **Radar**: Military green radar sweep (NEW in v1.11.2)
...
### Auto-Detection Feature (v1.11.2+)
