...
Controller for bi-directional LED garland and 8x8 NeoPixel matrix animation on ESP32 Classic (IdeaSpark/DevKitC) with ST7789 display, auto-detection of PIR/RCWL-0516, modern web interface with radio buttons and responsive 2-column layout, web-based OTA updates, physical buttons, 11 garland animations, 37 festive matrix animations (Christmas, New Year, Easter), dual independent control, smart modes, persistent configuration, automatic startup animations.
...
**Current Version: v1.9.0** (2025-12-31)
