...
static const AnimMapEntry ANIM_MAP[] = {
    ...
    {"wave", ANIM_SMOOTH_WAVE},
    {"onde", ANIM_SMOOTH_WAVE},
    {"strobe", ANIM_STROBE},
    {"pulse", ANIM_PULSE},
    {"poursuite", ANIM_CHASE},
    {"chase", ANIM_CHASE},
    {"heartbeat", ANIM_HEARTBEAT},
    {"coeur", ANIM_HEARTBEAT},
    {"sparkle", ANIM_SPARKLE},
    {"scintillement", ANIM_SPARKLE},
    {"rainbow", ANIM_RAINBOW_WAVE},
    {"arc", ANIM_RAINBOW_WAVE},
